...
@InitiatingFlow
@StartableByRPC
class LeadgerBlocksAccountFlow(private val name: String, private val imei: String, private val type: String): FlowLogic<UUID>(){
...
@InitiatedBy(LeadgerBlocksAccountFlow::class)
class LeadgerBlocksAccountFlowResponderFlow(val otherPartySession: FlowSession): FlowLogic<SignedTransaction>(){
